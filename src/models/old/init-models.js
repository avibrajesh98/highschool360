...
var _tbl_academic_year = require("./tbl_academic_year");
var _tbl_class_master = require("./tbl_class_master");
var _tbl_class_teacher = require("./tbl_class_teacher");
var _tbl_country_city_code = require("./tbl_country_city_code");
var _tbl_country_state_code = require("./tbl_country_state_code");
var _tbl_exam_evaluation = require("./tbl_exam_evaluation");
var _tbl_exam_grades = require("./tbl_exam_grades");
var _tbl_exam_schedule = require("./tbl_exam_schedule");
var _tbl_exam_schedule_assign = require("./tbl_exam_schedule_assign");
var _tbl_exam_type = require("./tbl_exam_type");
var _tbl_expense_master = require("./tbl_expense_master");
var _tbl_expense_records = require("./tbl_expense_records");
var _tbl_grade_range = require("./tbl_grade_range");
var _tbl_invoice_master = require("./tbl_invoice_master");
var _tbl_invoice_records = require("./tbl_invoice_records");
var _tbl_library = require("./tbl_library");
var _tbl_notice = require("./tbl_notice");
var _tbl_notice_type = require("./tbl_notice_type");
var _tbl_parent = require("./tbl_parent");
var _tbl_principal_info = require("./tbl_principal_info");
var _tbl_ref_codes = require("./tbl_ref_codes");
var _tbl_school = require("./tbl_school");
var _tbl_staff = require("./tbl_staff");
var _tbl_staff_attendance = require("./tbl_staff_attendance");
var _tbl_student_attendance = require("./tbl_student_attendance");
var _tbl_student_info = require("./tbl_student_info");
var _tbl_student_manage = require("./tbl_student_manage");
var _tbl_study_material = require("./tbl_study_material");
var _tbl_study_material_evaluation = require("./tbl_study_material_evaluation");
var _tbl_subject_allocation = require("./tbl_subject_allocation");
var _tbl_subject_master = require("./tbl_subject_master");
var _tbl_super_admin = require("./tbl_super_admin");
var _tbl_teacher_manage = require("./tbl_teacher_manage");
var _tbl_timetable = require("./tbl_timetable");
var _tbl_timetable_assign = require("./tbl_timetable_assign");
var _tbl_transport = require("./tbl_transport");

function initModels(sequelize) {
  var number = _number(sequelize, DataTypes);
  var tbl_academic_year = _tbl_academic_year(sequelize, DataTypes);
  var tbl_class_master = _tbl_class_master(sequelize, DataTypes);
  var tbl_class_teacher = _tbl_class_teacher(sequelize, DataTypes);
  var tbl_country_city_code = _tbl_country_city_code(sequelize, DataTypes);
  var tbl_country_state_code = _tbl_country_state_code(sequelize, DataTypes);
  var tbl_exam_evaluation = _tbl_exam_evaluation(sequelize, DataTypes);
  var tbl_exam_grades = _tbl_exam_grades(sequelize, DataTypes);
  var tbl_exam_schedule = _tbl_exam_schedule(sequelize, DataTypes);
  var tbl_exam_schedule_assign = _tbl_exam_schedule_assign(sequelize, DataTypes);
  var tbl_exam_type = _tbl_exam_type(sequelize, DataTypes);
  var tbl_expense_master = _tbl_expense_master(sequelize, DataTypes);
  var tbl_expense_records = _tbl_expense_records(sequelize, DataTypes);
  var tbl_grade_range = _tbl_grade_range(sequelize, DataTypes);
  var tbl_invoice_master = _tbl_invoice_master(sequelize, DataTypes);
  var tbl_invoice_records = _tbl_invoice_records(sequelize, DataTypes);
  var tbl_library = _tbl_library(sequelize, DataTypes);
  var tbl_notice = _tbl_notice(sequelize, DataTypes);
  var tbl_notice_type = _tbl_notice_type(sequelize, DataTypes);
  var tbl_parent = _tbl_parent(sequelize, DataTypes);
  var tbl_principal_info = _tbl_principal_info(sequelize, DataTypes);
  var tbl_ref_codes = _tbl_ref_codes(sequelize, DataTypes);
  var tbl_school = _tbl_school(sequelize, DataTypes);
  var tbl_staff = _tbl_staff(sequelize, DataTypes);
  var tbl_staff_attendance = _tbl_staff_attendance(sequelize, DataTypes);
  var tbl_student_attendance = _tbl_student_attendance(sequelize, DataTypes);
  var tbl_student_info = _tbl_student_info(sequelize, DataTypes);
  var tbl_student_manage = _tbl_student_manage(sequelize, DataTypes);
  var tbl_study_material = _tbl_study_material(sequelize, DataTypes);
  var tbl_study_material_evaluation = _tbl_study_material_evaluation(sequelize, DataTypes);
  var tbl_subject_allocation = _tbl_subject_allocation(sequelize, DataTypes);
  var tbl_subject_master = _tbl_subject_master(sequelize, DataTypes);
  var tbl_super_admin = _tbl_super_admin(sequelize, DataTypes);
  var tbl_teacher_manage = _tbl_teacher_manage(sequelize, DataTypes);
  var tbl_timetable = _tbl_timetable(sequelize, DataTypes);
  var tbl_timetable_assign = _tbl_timetable_assign(sequelize, DataTypes);
  var tbl_transport = _tbl_transport(sequelize, DataTypes);
  ...
  tbl_staff.belongsTo(tbl_academic_year, { as: "st_ay", foreignKey: "st_ay_id"});
  tbl_academic_year.hasMany(tbl_staff, { as: "tbl_staffs", foreignKey: "st_ay_id"});
  tbl_student_info.belongsTo(tbl_academic_year, { as: "si_ay", foreignKey: "si_ay_id"});
  ...
  tbl_subject_allocation.belongsTo(tbl_academic_year, { as: "sa_ay", foreignKey: "sa_ay_id"});
  ...
  tbl_class_teacher.belongsTo(tbl_class_master, { as: "ct_c", foreignKey: "ct_c_id"});
  ...
  tbl_grade_range.belongsTo(tbl_exam_grades, { as: "gr_eg", foreignKey: "gr_eg_id"});
  ...
  tbl_exam_evaluation.belongsTo(tbl_student_info, { as: "ee_si", foreignKey: "ee_si_id"});
  tbl_student_info.hasMany(tbl_exam_evaluation, { as: "tbl_exam_evaluations", foreignKey: "ee_si_id"});
  ...
  tbl_exam_schedule_assign.belongsTo(tbl_subject_master, { as: "esa_", foreignKey: "esa_s_id"});
  tbl_subject_master.hasMany(tbl_exam_schedule_assign, { as: "tbl_exam_schedule_assigns", foreignKey: "esa_s_id"});
  tbl_subject_allocation.belongsTo(tbl_subject_master, { as: "sa_", foreignKey: "sa_s_id"});
